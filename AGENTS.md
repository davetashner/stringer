...
│   │   ├── deadcode.go         # Dead code: regex symbol extraction (functions/types, 14 languages) then unreferenced-symbol detection; test files count as test-only references
