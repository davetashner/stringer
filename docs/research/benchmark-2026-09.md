...
## Results after the fixes (main at 0e10cf5, 2026-09-19)
...
re-run with the same runner on a build of main at 0e10cf5 under
...
| gitlog, lotteryrisk | History walked once per repository and shared across workspaces; signals scoped to each workspace instead of repeated per workspace; nested member directories excluded from the root walk | #457, #458, #459 |
...
|------------|---------------:|--------------:|-------:|------------:|-----------:|------------:|-----------:|--------------:|-------------:|
| gin-gonic/gin | 299 | 165 | -45% | 7% | 8% | 4s | 3s | 4s | 3s |
| expressjs/express | 259 | 97 | -63% | 5% | 0% | 6s | 3s | 10s | 3s |
| pallets/flask | 283 | 100 | -65% | 3% | 0% | 4s | 2s | 3s | 2s |
| rust-lang/rustlings | 499 | 356 | -29% | 14% | 1% | 4s | 5s | 4s | 6s |
| tokio-rs/tokio | 1,834 | 1,089 | -41% | 1% | 1% | 36s | 20s | 37s | 25s |
| jellyfin/jellyfin | 2,542 | 2,969 | +17% | 9% | 11% | 46s | 58s | 46s | 52s |
| tiangolo/fastapi | 868 | 408 | -53% | 16% | 12% | 8s | 13s | 9s | 11s |
| laravel/framework | 4,169 | 1,589 | -62% | 3% | 2% | 3m 29s | 28s | 3m 26s | 25s |
| django/django | 4,297 | 1,293 | -70% | 10% | 13% | 2m 35s | 25s | 2m 37s | 24s |
| facebook/react | 8,970 | 5,568 | -38% | 5% | 9% | 2m 48s | 1m 11s | 2m 47s | 1m 12s |
| apache/kafka | 12,069 | 4,514 | -63% | 4% | 8% | 52m 32s | 1m 11s | 52m 18s | 1m 07s |
| kubernetes/kubernetes | 51,542 | 17,694 | -66% | 20% | 10% | 1h 57m | 10m 59s | 1h 50m | 9m 27s |
| vercel/next.js | 14,027 | 4,922 | -65% | 17% | 10% | 34m 59s | 1m 39s | 35m 05s | 1m 40s |

#### Signals by collector: before -> after

| Repository | complexity | coupling | deadcode | dephealth | docstale | duplication | githygiene | gitlog | lotteryrisk | patterns | todos | vuln |
|------------|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| gin-gonic/gin | 57 -> 39 | 0 -> 0 | 1 -> 0 | 0 -> 0 | 2 -> 2 | 200 -> 95 | 0 -> 0 | 0 -> 0 | 7 -> 4 | 29 -> 22 | 2 -> 2 | 1 -> 1 |
...
| tokio-rs/tokio | 365 -> 76 | 1 -> 1 | 180 -> 6 | 2 -> 2 | 8 -> 8 | 692 -> 436 | 0 -> 0 | 40 -> 4 | 0 -> 34 | 455 -> 431 | 76 -> 76 | 15 -> 15 |
| jellyfin/jellyfin | 0 -> 915 | 0 -> 42 | 0 -> 227 | 0 -> 0 | 1 -> 1 | 200 -> 200 | 9 -> 8 | 30 -> 30 | 228 -> 122 | 1,918 -> 1,268 | 156 -> 156 | 0 -> 0 |
| tiangolo/fastapi | 111 -> 67 | 0 -> 0 | 104 -> 1 | 0 -> 0 | 39 -> 1 | 200 -> 200 | 32 -> 13 | 2 -> 2 | 90 -> 35 | 233 -> 32 | 50 -> 50 | 7 -> 7 |
...
| facebook/react | 1,748 -> 1,043 | 29 -> 29 | 514 -> 2 | 0 -> 0 | 36 -> 36 | 3,807 -> 2,147 | 0 -> 0 | 120 -> 2 | 4 -> 99 | 1,606 -> 1,104 | 1,020 -> 1,020 | 86 -> 86 |
| apache/kafka | 5,208 -> 1,367 | 0 -> 0 | 1,186 -> 594 | 0 -> 5 | 530 -> 0 | 200 -> 200 | 63 -> 47 | 0 -> 0 | 96 -> 63 | 4,625 -> 2,077 | 161 -> 161 | 0 -> 0 |
| kubernetes/kubernetes | 24,140 -> 5,939 | 102 -> 120 | 952 -> 626 | 187 -> 187 | 72 -> 103 | 5,166 -> 3,174 | 199 -> 140 | 4,998 -> 136 | 89 -> 291 | 11,937 -> 4,361 | 3,531 -> 2,520 | 169 -> 97 |
| vercel/next.js | 8,262 -> 1,093 | 79 -> 79 | 145 -> 92 | 0 -> 0 | 20 -> 20 | 1,564 -> 1,087 | 3 -> 1 | 1,012 -> 3 | 1 -> 68 | 2,051 -> 1,610 | 802 -> 777 | 88 -> 92 |

#### Slowest collector after the fixes

| Repository | Collector | Time | Share of scan |
|------------|-----------|-----:|--------------:|
| gin-gonic/gin | duplication | 3s | 100% |
| expressjs/express | duplication | 3s | 100% |
| pallets/flask | duplication | 2s | 100% |
| rust-lang/rustlings | todos | 5s | 100% |
| tokio-rs/tokio | patterns | 15s | 76% |
| jellyfin/jellyfin | patterns | 58s | 100% |
| tiangolo/fastapi | duplication | 13s | 100% |
| laravel/framework | patterns | 28s | 100% |
| django/django | complexity | 25s | 100% |
| facebook/react | duplication | 57s | 81% |
| apache/kafka | patterns | 1m 11s | 100% |
| kubernetes/kubernetes | complexity | 7m 04s | 64% |
| vercel/next.js | patterns | 52s | 52% |

#### Pinned commits (re-run)

| Repository | Commit | Date | Errors/Warnings (scan stderr) |
|------------|--------|------|------------------------------|
| gin-gonic/gin | `3b08cd7235` | 2026-09-19 | 0/1 |
...
| vercel/next.js | `75b9f201be` | 2026-09-19 | 0/46 |
| kubernetes/kubernetes | `96b5e4e3ae` | 2026-09-18 | 0/34 |

An earlier pass of this re-run hit repo1.maven.org rate limiting (HTTP 429) and reported no Kafka dependency-health findings; PR #456 now surfaces such failures, and this run found the 5 stale artifacts normally. The warning counts in the last column are the per-workspace shallow-history notices from the lottery-risk collector, not errors.
...
- Timing is dominated by the dead-code fix. Kafka's scan goes from 52
  minutes of collector time to 71 seconds, next.js from 35 minutes to
  1m 39s, kubernetes from two hours to 11 minutes. Sharing the git
  history across workspaces (#457) and scoping signals per workspace
  (#458, #459) account for the monorepo gains; kubernetes also loses
  about 10,000 duplicated signals it used to report once per workspace. Dependency health
...
- The "High" share is 0% on express and flask: their only high-confidence signals were the version floors now reported at 0.5. A repository with no real findings above 0.8 should read as such.
- Complexity is now the slowest collector on kubernetes (7 minutes over 34 workspaces) and patterns on Kafka and Jellyfin; both are file walks that could share one traversal per scan.
